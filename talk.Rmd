...
rmarkdown::render("talk.Rmd", output_format = beamer_presentation(theme = "Pittsburgh", colortheme = "spruce", fonttheme = "structurebold")) 
rmarkdown::render("talk.Rmd", output_format = beamer_presentation(theme = "Execushares", latex_engine = "lualatex")) 
